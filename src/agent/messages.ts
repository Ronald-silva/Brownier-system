...
export const MESSAGE_CATALOG: Record<string, string> = {
  ...
  BUSINESS_OPERATING_HOURS: "Nossos horários de atendimento são:\n\n{hours}",
  BUSINESS_TOMORROW_OPEN: "Amanhã, {weekday}, atendemos das {hours}.",
  BUSINESS_TOMORROW_CLOSED: "Amanhã, {weekday}, não teremos retirada.",
